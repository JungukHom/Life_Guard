namespace BusinessConversation.CHN.Hotel
{
    ...
    public class _02_Menu_Airport : MonoBehaviour
    {
        [Header("우측 판넬 설명/내용")]
        ...
        private void ShowLearningTargetData()
        {
            ...
            List<CSVLODataHolder> list = container.GetData(ELocation.Airport, (EAirportLesson)selectedLessonIndex);
